...
def safe() -> None:
  ...
  while playing == True:
    while round_idx <= 5:
        ...
        player_guess = input(f"Round {round_idx}/5: The random number will be within the bounds of 0 and 20. What is your guess? ")
...
def main() -> None:
  ...
  playing: bool = True
  choice: str = input("If you want to play the low risk/easy game, enter the number 1. If you want to play the high risk/hard game, enter the number 2. If you want to exit, enter any other number! ")
  choice = int(choice)
  while playing == True:
    if choice == 1:
        safe()
    ...
    decision: int = input(f"Your last attempt yielded {points} points, but you can keep playing to get lower! If you want to play the easy version, enter the number 1. If you want to play the hard version, enter the number 2. If you want to stop playing, type in any other number! ")
